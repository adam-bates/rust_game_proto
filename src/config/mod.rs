...
pub const VIEWPORT_PIXELS_WIDTH_USIZE: usize = VIEWPORT_TILES_WIDTH_USIZE * TILE_SIZE_USIZE;
pub const VIEWPORT_PIXELS_WIDTH_F32: f32 = VIEWPORT_PIXELS_WIDTH_USIZE as f32;

pub const VIEWPORT_PIXELS_HEIGHT_USIZE: usize = VIEWPORT_TILES_HEIGHT_USIZE * TILE_SIZE_USIZE;
